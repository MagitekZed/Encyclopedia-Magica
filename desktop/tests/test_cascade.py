...
from tests.common import (ee_item, first_plain_item, first_reroll_enh_roll,
                          first_reroll_item, get_dataset)
...
class TestCascade(unittest.TestCase):
    ...
    def test_r3_within_armor_shares_outer_budget(self):
        ...
        deep = self.eng([1, 11, rr3.roll_low, rr3.roll_low])._assemble_armor(2)
        ...
        shallow = self.eng([1, 11] + [rr3.roll_low] * 4)._assemble_armor(0)
